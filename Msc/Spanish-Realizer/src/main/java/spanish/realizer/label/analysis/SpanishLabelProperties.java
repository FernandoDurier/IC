...
public class SpanishLabelProperties implements ILabelProperties
{
	...
	private boolean isVerb;							// If first word is a verb
	...
	public SpanishLabelProperties()
	{
		...
		prepositions.addAll(Arrays.asList(LanguageData.articlePrepositions));
		prepositions.addAll(Arrays.asList(LanguageData.noArticleprepositions));
		prepositions.addAll(PrepositionManager.getInstance().getAllPrepositions());
