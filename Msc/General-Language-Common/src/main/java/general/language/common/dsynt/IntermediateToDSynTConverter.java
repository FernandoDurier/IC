package general.language.common.dsynt;
	...
	public static Element createConditionNode(Document doc, ConditionFragment cFrag) {
		if (cFrag.getType() != ConditionFragment.TYPE_NONE) {
			...
			case ConditionFragment.TYPE_IF:
				ifNode.setAttribute("lexeme", Localization.getInstance().getLocalizedMessage(Messages.IF)); break;
			case ConditionFragment.TYPE_AS_LONG_AS:
				ifNode.setAttribute("lexeme", Localization.getInstance().getLocalizedMessage(Messages.AS_LONG_AS)); break;
			case ConditionFragment.TYPE_ONCE:
				ifNode.setAttribute("lexeme", Localization.getInstance().getLocalizedMessage(Messages.ONCE)); break;
			case ConditionFragment.TYPE_WHETHER:
				ifNode.setAttribute("lexeme", Localization.getInstance().getLocalizedMessage(Messages.WHETHER)); break;
			case ConditionFragment.TYPE_WHEN:
				ifNode.setAttribute("lexeme",Localization.getInstance().getLocalizedMessage(Messages.WHEN)); break;
			case ConditionFragment.TYPE_IN_CASE:
				ifNode.setAttribute("lexeme", Localization.getInstance().getLocalizedMessage(Messages.IN_CASE)); break;	
			}
			return ifNode;
		} else {
			return null;
